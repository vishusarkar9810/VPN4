...
extension UIColor {
    ...
    func lighterColor() -> UIColor {
            ...
            var b : CGFloat = 0
            var a: CGFloat = 0
            let success: Bool = getRed(&r, green: &g, blue: &b, alpha: &a)
            if success {
        ...
        func darkerColor() -> UIColor {
            ...
            let success: Bool = getRed(&r, green: &g, blue: &b, alpha: &a)
            if success {
                return UIColor(red: CGFloat(max(r-0.1, 0.0)), green: CGFloat(max(g-0.1, 0.0)), blue: CGFloat(max(b-0.1, 0.0)), alpha: a)
            } else {
                return self
            }
        }
