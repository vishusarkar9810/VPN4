...
public class CustomCollectionView: TPKeyboardAvoidingCollectionView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDropDelegate, UICollectionViewDragDelegate {
...
//		_refreshView?.showActivity()
    ...
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
		...
		return _delegate?.cellSize?(self, cellDict: cellDict, indexPath: indexPath) ?? cellSize
	}
    ...
    public func setup(
        ...
        delegate: CustomCollectionViewDelegate?, complexLayout: Bool? = false, gridSectionInfo: [Int: [String: Any]] = [:]) {
...
//		_refreshView?.hideActivity()
	...
	private func createLayout() -> UICollectionViewLayout {
		...
		let compos =  UICollectionViewCompositionalLayout { [self] sectionNumber, _ -> NSCollectionLayoutSection? in
			let _gridViewType = (_gridSectionInfo[sectionNumber]?[kSectionViewType]) as! CustomCollectionView.CollectionViewType
			let layoutType = ((_gridSectionInfo[sectionNumber]?[kSectionOrientationType] ?? SectionOrientation.horizontal) as! CustomCollectionView.SectionOrientation)
